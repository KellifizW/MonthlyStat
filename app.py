...
def test_page():
    ...
    if uploaded_file is not None:
        ...
        # 檢查必要的欄位是否存在
        required_uploaded_cols = ['RespStaff', '2ndRespStaffName']
        required_github_cols = ['staff1', 'staff2']
        ...
        # 提取 GitHub CSV 中的本區員工名單
        local_staff = set(github_df['staff1'].dropna().tolist() + github_df['staff2'].dropna().tolist())
        ...
        uploaded_df['區域'] = uploaded_df.apply(check_local, axis=1)
